...
export const About = () => {
  return (
    <div className="container containerAbout d-flex flex-column justify-content-center align-items-center px-5 py-5 mx-auto">
      <div className="containerAboutBox flex-grow pr-5 text-center">
        ...
        <p>
          ...
          I'm very passionate about technology and I would love to connect with
